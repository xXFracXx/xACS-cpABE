	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                String[] aaArr = new String[]{"aa1", "aa2", "aa3", "aa4", "aa5", "aa6", "aa7", "aa8", "aa9", "aa10"};
                ...
                int i = st.executeUpdate("update request set aCount= " + currCount + " where id = '" + id + "'");
                if (i == 0) {
                ...
                con = DbConnection.getConnection();
                st = con.createStatement();
                i = st.executeUpdate("update request set " + aaArr[aaIndex] + " = '" + user_id + "' where id = '" + id + "'");
                if (i == 0) {
