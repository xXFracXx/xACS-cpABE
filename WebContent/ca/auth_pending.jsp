...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>Auth Pending - CA | xACS </title>
    ...
    <body>
            ...
            <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
                ...
                <div class="col g-bg-lightblue-v10-opacity-0_5 g-ml-45 g-ml-0--lg g-pb-65--md">
                    ...
                    <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
                        <ul class="u-list-inline g-color-gray-dark-v6">
                            ...
                            <li class="list-inline-item">
                                <span class="g-valign-middle">Authorization Pending</span>
                            </li>
                        </ul>
                    </div>
                    <!-- End Breadcrumb-v1 -->
                    ...
                    <div class="g-pa-20">
                        ...
                        <div class="alert alert-success alert-dismissible fade show" role="alert" id="authSuccAlert" style="visibility: hidden; display: none;">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" role="alert" id="authFailAlert" style="visibility: hidden; display: none;">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                            <h4 class="h5">
                                <i class="fa fa-minus-circle"></i>
                                Unable to activate User/AA! Please try again later.
                            </h4>
                        ...
                        <div class="media-md align-items-center g-mb-30">
                            <div class="d-flex g-mb-15 g-mb-0--md">
                                <h1 class="g-font-weight-500 g-font-size-28 g-color-black">Authorization Pending</h1>
                            </div>
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            try {
                                                ...
                                                rs = st.executeQuery("select * from reg where (role='User' and status='No') or (role='AA' and status='No')");
                                                while (rs.next()) {
                                            ...
                                            <td style=" width:0.1%; white-space: nowrap;">
                                                <div class="media">
                                                    <div class="media-body align-self-center" href="#!">
                                                        <a class="u-tags-v1 text-center g-bg-lightblue-v3 g-brd-lightblue-v3 g-width-140 g-color-white g-brd-around g-rounded-50 g-py-4 g-px-15" href="../ca_activate?id=<%=rs.getString("id")%>" style="font-weight: bolder;">Activate</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
        ...
        <script>
            $(document).ready(function () {
                ...
                if (window.location.href.indexOf('#authSucc') !== -1) {
                    $('#authSuccAlert').css({
                        'visibility': 'visible',
                        'display': 'block'
                    });
                ...
                if (window.location.href.indexOf('#authFail') !== -1) {
                    $('#authFailAlert').css({
                        'visibility': 'visible',
                        'display': 'block'
                    });
