                            ...
                            <div class="col-xl-9">
                                ...
                                <div class="card g-brd-gray-light-v7 u-card-v1 g-pa-15 g-pa-25-30--md g-mb-30">
                                    <header class="media g-mb-30">
                                        <h3 class="d-flex align-self-center text-uppercase g-font-size-12 g-font-size-default--md g-color-black mb-0">Account statistics</h3>
                                        ...
                                        <ul class="list-unstyled d-flex align-self-center pull-right" style="margin-bottom: 0px !important; margin-left: 20px !important;" id="">
                                            <li class="media g-ml-5 g-ml-35--md">
                                                ...
                                                <div class="media-body align-self-center g-font-size-12 g-font-size-default--md">Monthly Users Registered</div>
                                            </li>
                                        </ul>
                                    </header>
                                    ...
                                    <%
                                        ...
                                        try {
                                            ...
                                            rs = st.executeQuery("SELECT YEAR(joinDate) AS 'Year', MONTH(joinDate) AS 'Month', COUNT(*) AS 'Visits1' FROM reg WHERE role = 'AA' GROUP BY MONTH(joinDate), YEAR(joinDate) ORDER BY  'Year', 'Month'");
                                            while (rs.next()) {
                                            ...
                                            rs = st.executeQuery("SELECT YEAR(joinDate) AS 'Year', MONTH(joinDate) AS 'Month', COUNT(*) AS 'Visits2' FROM reg WHERE role = 'User' GROUP BY MONTH(joinDate), YEAR(joinDate) ORDER BY  'Year', 'Month'");
                                            while (rs.next()) {
                                                month = Integer.parseInt(rs.getString("Month")) - 1;
...
//                                            
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-lg-4 col-xl-4 g-mb-30">
                                ...
                                <%  con = null;
                                    ...
                                    try {
                                        ...
                                        rs = st.executeQuery("select count(*) AS num5 from reg where role='AA' AND DATE(`joinDate`) = CURDATE()");
                                        rs.next();
                                        ...
                                        rs = st.executeQuery("select count(*) AS num6 from reg where role='User' AND DATE(`joinDate`) = CURDATE()");
                                        rs.next();
                                            ...
                                            <div class="card-block g-font-weight-300 g-pa-20">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body align-self-center">
                                                        ...
                                                        <h6 class="g-font-size-16 g-font-weight-600 g-color-gray-dark-v6 mb-0">AAs Authorized</h6>
                                                    ...
                                                    <div class="d-flex align-self-center g-ml-12 g-mb-7">
                                                        ...
                                                        <svg class="<%=aa_arrow_class%>" width="12px" height="20px" viewBox="0 0 12 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                            ...
                                            <div class="card-block g-font-weight-300 g-pa-20">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body align-self-center">
                                                        ...
                                                        <h6 class="g-font-size-16 g-font-weight-600 g-color-gray-dark-v6 mb-0">Users Authorized</h6>
                                                    </div>
                                                    ...
                                                    <div class="d-flex align-self-center g-ml-12 g-mb-7">
                                                        ...
                                                        <svg class="<%=user_arrow_class%>" width="12px" height="20px" viewBox="0 0 12 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                        <g transform="translate(-33.000000, -751.000000)">
                                                        <g transform="translate(0.000000, 64.000000)">
                                                        <g transform="translate(20.000000, 619.000000)">
                                                        <g transform="translate(1.000000, 68.000000)">
                            ...
                            <div class="col-xl-8">
                                ...
                                <div class="card g-brd-gray-light-v7 u-card-v1 g-pa-15 g-pa-25-30--md g-mb-30">
                                    <header class="media g-mb-30">
                                        <h3 class="d-flex align-self-center text-uppercase g-font-size-12 g-font-size-default--md g-color-black mb-0">Latest Signup(s)</h3>
                                    </header>
                                        ...
                                        <div class="row">
                                            ...
                                            <%  con = null;
                                                ...
                                                try {
                                                    con = DbConnection.getConnection();
                                                    st = con.createStatement();
                                                    rs = st.executeQuery("select name, id, joinDate, role, status from reg where role='User' or role='AA' ORDER BY joinDate DESC LIMIT 6");
                                            ...
                                            <section>
                                                <div class="media">
                                                    ...
                                                    <div class="d-flex g-font-size-16 g-color-gray-dark-v6">
                                                        <%=rs.getString("role")%><a class="u-link-v5 g-font-size-16 g-color-lightblue-v3" href="#!">&nbsp;#<%=rs.getString("id")%></a>
                                                    </div>
                                                </div>

                                                <div class="media">
                                                    <div class="media-body align-self-center" href="#!">
                                                        <a class="u-tags-v1 text-center<%=span_class%> g-width-140 g-color-white g-brd-around g-rounded-50 g-py-4 g-px-15" <%=span_tag%> style="font-weight: bolder;"><%=span_text%></a>
                                                    </div>
                                                    ...
                                                    <em class="d-flex align-self-center align-items-center g-font-style-normal">
                                                        ...
                                                        <span class="g-font-weight-300 g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-ml-4 g-ml-8--md"><%=time_num%><%=time_text%> <span class="g-hidden-md-down">ago</span></span>
                                                    </em>
                                                </div>
                                            </section>
        ...
        <script>
            ...
            new Chart(document.getElementById("line-chart"), {
                ...
                data: {
                    labels: [<%=month_list%>],
                    datasets: [{
                            data: [<%=month_visits_user[indexArray[t2]]%>,
