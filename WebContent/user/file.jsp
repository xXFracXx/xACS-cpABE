...
<html lang="en">
    ...
    <body>
        ...
        <main class="container-fluid px-0 g-pt-65">
            ...
            <%
                String skey = (String) session.getAttribute("ssidsecretkey");
                System.out.println("owner>>--->>" + skey);
                Connection con = null;
                Statement st = null;
                ResultSet rs = null;
                try {
                    ...
                    rs = st.executeQuery("select * from file_upload where secret_key='" + skey + "' LIMIT 1");
                    rs.next();
            %>
            ...
            <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
                ...
                <div id="sideNav" class="col-auto u-sidebar-navigation-v1 u-sidebar-navigation--dark">
                    <ul id="sideNavMenu" class="u-sidebar-navigation-v1-menu u-side-nav--top-level-menu g-min-height-100vh mb-0">
                        ...
                        <li class="u-sidebar-navigation-v1-menu-item u-side-nav--top-level-menu-item">
                            <a class="media u-side-nav--top-level-menu-link u-side-nav--hide-on-hidden g-px-15 g-py-12" href="file_request.jsp">
                                <span class="d-flex align-self-center g-pos-rel g-font-size-18 g-mr-18">
                                    <i class="hs-admin-exchange-vertical"></i>
                                </span>
                                <span class="media-body align-self-center">File Request</span>
                            </a>
                        </li>
                        <li class="u-sidebar-navigation-v1-menu-item u-side-nav--has-sub-menu u-side-nav--top-level-menu-item u-side-nav-opened has-active">
                            <a class="media u-side-nav--top-level-menu-link u-side-nav--hide-on-hidden g-px-15 g-py-12" href="file_download.jsp">
                                <span class="d-flex align-self-center g-pos-rel g-font-size-18 g-mr-18">
                                    <i class="hs-admin-cloud-down"></i>
                                </span>
                                <span class="media-body align-self-center">File Download</span>
                            ...
                            <ul id="subMenuLevels1" class="u-sidebar-navigation-v1-menu u-side-nav--second-level-menu mb-0" style="display: block;">
                                <!-- Sub Level 2 -->
                                <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item has-active">
                                    <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="#!">
                                        <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
                                            <i class="hs-admin-file"></i>
                                        </span>
                                        <span class="media-body align-self-center"><%=rs.getString("filename")%></span>
                                    </a>
                                </li>
                                <!-- End Sub Level 2 -->
                            </ul>
                ...
                <div class="col g-bg-lightblue-v10-opacity-0_5 g-ml-45 g-ml-0--lg g-pb-65--md">
                    ...
                    <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
                        <ul class="u-list-inline g-color-gray-dark-v6">
                            ...
                            <li class="list-inline-item g-mr-10">
                                <a class="u-link-v5 g-color-gray-dark-v6 g-color-lightblue-v3--hover g-valign-middle" href="dashboard.jsp">User</a>
                                <i class="hs-admin-angle-right g-font-size-12 g-color-gray-light-v6 g-valign-middle g-ml-10"></i>
                            </li>

                            <li class="list-inline-item">
                                <a class="u-link-v5 g-color-gray-dark-v6 g-color-lightblue-v3--hover g-valign-middle" href="file_download.jsp">File Download</a>
                                <i class="hs-admin-angle-right g-font-size-12 g-color-gray-light-v6 g-valign-middle g-ml-10"></i>
                            </li>

                            <li class="list-inline-item">
                                <span class="g-valign-middle">File</span>
                            </li>
                        </ul>
                    </div>
                    <!-- End Breadcrumb-v1 -->
                    <div class="g-pa-20">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" role="alert" id="dlFailAlert" style="visibility: hidden; display: none;">
                        ...
                        <div class="row g-pr-15 g-pl-15">

                            <div class="col-md-12 g-pb-15" style="padding-left: 0px; padding-right: 0px">
                                <div class="g-pos-rel g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-30--md u-card-v1">
                                    <header>
                                        <div class="row">
                                            <div class="col-auto g-width-280">
                                                <h1 class="g-font-weight-500 g-font-size-28 g-color-black g-mb-20">Download File</h1>
                                            </div>
                                        </div>
                                    </header>

                                    <hr class="d-flex g-brd-gray-light-v7 g-my-15 g-mt-5--md g-mb-20--md">

                                    <div class="g-mb-10 btn-block">

                                        <form action="../user_fileDownload">
                                            <label class="g-mb-10" for="inputGroup1_2">Enter Secret Key</label>
                                            <div class="input-group u-file-attach-v1 g-brd-gray-light-v2">
                                                <input class="form-control form-control-md rounded-50" name="sk" type="text" style="padding: .375rem .75rem; line-height: 1.5;">

                                                <div class="input-group-btn">
                                                    <button class="btn btn-md u-btn-primary rounded-50" type="submit"><i class="fa fa-cloud-download g-mr-5"></i>
                                                        Verification
                                                    </button>
                                                </div>
                                            </div>
                        ...
                        <div class="row g-pr-15 g-pl-15">
                            ...
                            <%
                                ...
                                String[] types = {"txt", "doc", "json", "sql", "html", "htm", "java", "docx"};

                                int i = -1;
                                for (i = 0; i < types.length; i++) {
                                    if (extension.contains(types[i])) {
                                        break;
                                    }
                                }
                                ...
                                if (isRead) {
                                    ...
                                    Connection _con = DriverManager.getConnection("jdbc:mysql://us-cdbr-iron-east-05.cleardb.net/heroku_925e3cb61718614", "b45ac8d6e3ff55", "57d84b63");
                                    Statement _st = _con.createStatement();

                                    Blob blob = null;
                                    ResultSet _rs = _st.executeQuery("select * from file_upload where id = '" + fileId + "' ");
                                    while (_rs.next()) {

                                        blob = _rs.getBlob("content");
                                        _skey = _rs.getString("secret_key");
                                    }
                                    byte a[] = blob.getBytes(1, (int) blob.length());
                                    String str = new String(a, "UTF-8");
                                    dec = new decryption().decrypt(str, _skey);
                            ...
                            <div class="col-md-5 g-pb-5 g-pr-10" style="padding-left: 0px; padding-right: 0px">
                                <div class="g-pos-rel g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md u-card-v1">
                                    <header>
                                        <div class="row">
                                            <div class="col-auto media">
                                                <span class="g-font-size-20 g-line-height-1 g-font-weight-400 g-color-primary align-self-center" style="padding-bottom: 8px !important">#<%=rs.getString("id")%>&nbsp;</span>
                                                <h1 class="g-font-weight-400 g-font-size-18 g-color-black g-mb-5"><%=rs.getString("filename")%></h1>
                                            </div>

                                            <div class="media-body d-flex justify-content-end">
                                                <a class="u-tags-v1 text-center g-width-100 g-brd-around g-brd-teal-v2 g-bg-teal-v2 g-font-size-default g-color-white g-rounded-50 g-py-4 g-px-15 g-mr-10" id="viewBt" style="display:none;" href="file.jsp?#view">View</a>
                                                <a class="u-tags-v1 text-center g-width-100 g-brd-around g-brd-lightblue-v3 g-bg-lightblue-v3 g-font-size-default g-color-white g-rounded-50 g-py-4 g-px-15 g-mr-20" href="../Download?<%=rs.getString("id")%>">Download</a>
                                            </div>
                                        </div>
                                    </header>

                                    <hr class="d-flex g-brd-gray-light-v7 g-my-15 g-mt-10--md g-mb-20--md">

                                    <div class="card-block g-pa-10">
                                        <div class="row">
                                            <div class="col-md-4 g-mb-25 g-mb-0--md">
                                                <h5 class="g-font-size-default g-color-gray-dark-v6 g-mb-5">Upload Date/Time</h5>
                                                <p class="g-color-black mb-0"><%=rs.getString("time")%></p>
                                            </div>

                                            <div class="col-md-4">
                                                <h5 class="g-font-size-default g-color-gray-dark-v6 g-mb-5">Secret Key</h5>
                                                <p class="g-color-black mb-0 ink"><small><%=skey%></small></p>
                                            </div>

                                            <div class="col-md-4">
                                                <h5 class="g-font-size-default g-color-gray-dark-v6 g-mb-5">File Owner</h5>
                                                <p class="g-color-black mb-0"><%=rs.getString("owner")%></p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-7 g-pb-5 g-pl-5" id="viewDiv" style="padding-left: 0px; padding-right: 0px; display: none;">
                                <div class="g-pos-rel g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md u-card-v1">
                                    <header>
                                        <div class="row">
                                            <div class="col-auto media g-width-280">
                                                <h1 class="g-font-weight-300 g-font-size-18 g-color-black g-mb-5">View File</h1>
                                            </div>

                                            <div class="media-body d-flex justify-content-end">
                                                <a class="u-tags-v1 text-center g-width-70 g-brd-around g-brd-red g-bg-white g-font-size-default g-color-red g-rounded-50 g-py-4 g-px-15 g-mr-20" href="file.jsp">Close</a>
                                            </div>
                                        </div>
                                    </header>
                                    ...
                                    <div class="card-block g-pa-10">
                                        <textarea name="file" rows="17" style="width: 100%;"><%=dec%></textarea>
