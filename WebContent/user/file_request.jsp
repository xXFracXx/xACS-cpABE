...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>File Request - User | xACS </title>
    ...
    <body>
            ...
            <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
                ...
                <div class="col g-bg-lightblue-v10-opacity-0_5 g-ml-45 g-ml-0--lg g-pb-65--md">
                    ...
                    <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
                        <ul class="u-list-inline g-color-gray-dark-v6">
                            ...
                            <li class="list-inline-item g-mr-10">
                                <a class="u-link-v5 g-color-gray-dark-v6 g-color-lightblue-v3--hover g-valign-middle" href="dashboard.jsp">Cloud</a>
                                <i class="hs-admin-angle-right g-font-size-12 g-color-gray-light-v6 g-valign-middle g-ml-10"></i>
                            </li>

                            <li class="list-inline-item">
                                <span class="g-valign-middle">File Request</span>
                            </li>
                        </ul>
                    </div>
                    <!-- End Breadcrumb-v1 -->
                    <div class="g-pa-20">
                        ...
                        <div class="alert alert-success alert-dismissible fade show" role="alert" id="reqSuccAlert" style="visibility: hidden; display: none;">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" role="alert" id="reqFailAlert" style="visibility: hidden; display: none;">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                            <h4 class="h5">
                                <i class="fa fa-minus-circle"></i>
                                Unable to request file! Please try again later.
                            </h4>
                        ...
                        <div class="row">
                            <div class="col-auto g-width-280">
                                <h1 class="g-font-weight-500 g-font-size-28 g-color-black g-mb-20">Request File</h1>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 g-mb-30">
                                        <div class="d-flex flex-wrap h-100 g-brd-around g-brd-gray-light-v7 g-rounded-2 u-card-v1 g-pa-25">
                                            ...
                                            <section class="w-100 align-self-center text-center g-color-darkblue-v2 g-mb-6">
                                            ...
                                            <footer class="w-100 align-self-end text-center">
                                                <div class="d-flex align-items-center justify-content-center g-mb-5">
                                                    <span class="g-line-height-1_2 g-font-size-default g-font-weight-600 g-color-black"><%=basename%></span>
                                                </div>

                                                <div class="d-flex align-items-center justify-content-center g-mb-">
                                                    <a href="../user_fileRequest?id=<%=rs.getString("id")%>" class="btn btn-sm g-font-weight-600 g-letter-spacing-0_5 text-uppercase g-brd-2 g-rounded-50 g-mr-10">
                                                        <i class="fa fa-arrow-circle-down g-mr-3"></i>
                                                        send request
                                                    </a>
                                                </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                if (window.location.href.indexOf('#reqSucc') !== -1) {
                    $('#reqSuccAlert').css({
                        'visibility': 'visible',
                        'display': 'block'
                    });
                ...
                if (window.location.href.indexOf('#reqFail') !== -1) {
                    $('#reqFailAlert').css({
                        'visibility': 'visible',
                        'display': 'block'
                    });
