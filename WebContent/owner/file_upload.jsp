            ...
            <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
                ...
                <div class="col g-bg-lightblue-v10-opacity-0_5 g-ml-45 g-ml-0--lg g-pb-65--md">
                    ...
                    <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
                        <ul class="u-list-inline g-color-gray-dark-v6">
                            ...
                            <li class="list-inline-item">
                                <span class="g-valign-middle">File Upload</span>
                            </li>
                        </ul>
                    </div>
                    <!-- End Breadcrumb-v1 -->
                    <div class="g-pa-20">
                        ...
                        <div class="alert alert-success alert-dismissible fade show" role="alert" id="uploadSuccAlert" style="visibility: hidden; display: none;">
                        ...
                        <div class="alert alert-warning alert-dismissible fade show" role="alert" id="dupFailAlert" style="visibility: hidden; display: none;">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                            <h4 class="h5">
                        ...
                        <div class="alert alert-warning alert-dismissible fade show" role="alert" id="sizeFailAlert" style="visibility: hidden; display: none;">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                            <h4 class="h5">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" role="alert" id="uploadFailAlert" style="visibility: hidden; display: none;">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                            <h4 class="h5">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" role="alert" id="ftpFailAlert" style="visibility: hidden; display: none;">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                            <h4 class="h5">
                        ...
                        <div class="col-md-12" style="padding-left: 0px; padding-right: 0px">
                            <div class="g-pos-rel h-100 g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-30--md u-card-v1">
                                <header>
                                    <div class="row">
                                        <div class="col-auto g-width-280">
                                            <h1 class="g-font-weight-500 g-font-size-28 g-color-black g-mb-20">Upload File</h1>
                                        </div>
                                        <div class="col">
                                ...
                                <hr class="d-flex g-brd-gray-light-v7 g-my-15 g-mt-5--md g-mb-30--md">

                                <div class="g-mb-10 btn-block">

                                    <form action="../Upload" method="Post" enctype="multipart/form-data">
                                        <input id="text1" type="text" name="public" value="<%=File_id%>" hidden="" required=""/>
                                        <div class="file-loading"> 
                                            <input id="text3" type="file" name="file" multiple="true" required="">
                                        </div>
                                    </form>
