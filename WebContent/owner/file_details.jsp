            ...
            <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
                ...
                <div id="sideNav" class="col-auto u-sidebar-navigation-v1 u-sidebar-navigation--dark">
                    <ul id="sideNavMenu" class="u-sidebar-navigation-v1-menu u-side-nav--top-level-menu g-min-height-100vh mb-0">
                        ...
                        <li class="u-sidebar-navigation-v1-menu-item u-side-nav--top-level-menu-item">
                            <a class="media u-side-nav--top-level-menu-link u-side-nav--hide-on-hidden g-px-15 g-py-12" href="file_upload.jsp">
                                <span class="d-flex align-self-center g-pos-rel g-font-size-18 g-mr-18">
                                    <i class="hs-admin-upload"></i>
                                </span>
                                <span class="media-body align-self-center">File Upload</span>
                            </a>
                        </li>
                ...
                <div class="col g-bg-lightblue-v10-opacity-0_5 g-ml-45 g-ml-0--lg g-pb-65--md">
                    ...
                    <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
                        <ul class="u-list-inline g-color-gray-dark-v6">
                            ...
                            <li class="list-inline-item g-mr-10">
                                <a class="u-link-v5 g-color-gray-dark-v6 g-color-lightblue-v3--hover g-valign-middle" href="dashboard.jsp">Owner</a>
                    ...
                    <div class="g-pa-20">
                        ...
                        <div class="alert alert-success alert-dismissible fade show" role="alert" id="delSuccAlert" style="visibility: hidden; display: none;">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" role="alert" id="delFailAlert" style="visibility: hidden; display: none;">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                            <h4 class="h5">
                                ...
                                <div class="row">
                                    ...
                                    <%
                                        ...
                                        try {
                                            ...
                                            rs = st.executeQuery("select *, OCTET_LENGTH(content) as size from file_upload where owner='" + owner + "'");
                                    ...
                                    <div class="col-md-3 g-mb-30">
                                        <div class="d-flex flex-wrap h-100 g-brd-around g-brd-gray-light-v7 g-rounded-2 u-card-v1 g-pa-25">
                                            <header class="w-100 align-self-start text-right justify-content-end g-pos-rel g-mb-10">
                                                ...
                                                <a id="dropDown<%=rsCount%>Invoker" class="u-link-v5 g-line-height-0 g-font-size-24 g-color-gray-light-v6 g-color-lightblue-v3--hover g-pr-10" href="#!" aria-controls="dropDown<%=rsCount%>" aria-haspopup="true" aria-expanded="false" data-dropdown-event="click" data-dropdown-target="#dropDown<%=rsCount%>" data-dropdown-type="jquery-slide">
                                                    <i class="hs-admin-more-alt"></i>
                                                </a>

                                                <div id="dropDown<%=rsCount%>" class="u-shadow-v31 g-pos-abs g-right-0 g-bg-white u-dropdown--jquery-slide u-dropdown--hidden" aria-labelledby="dropDown<%=rsCount%>Invoker" style="display: none; right: 0px;">
                                                    <ul class="list-unstyled g-nowrap mb-0">
                                                        <li>
                                                            <a class="d-flex align-items-center u-link-v5 g-bg-gray-light-v8--hover g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-px-25 g-py-14" href="../owner_fileDelete?<%=rs.getString("id")%>">
                                            ...
                                            <footer class="w-100 align-self-end text-center">
                                                ...
                                                <p class="g-font-weight-300 g-font-size-default g-color-gray-dark-v6 mb-10"><%=rs.getString("time")%> <strong>-</strong> <%=size_stirng%></p>
                                                <div class="media g-pos-rel g-bg-lightblue-v6 g-color-gray-dark-v6 g-rounded-10 g-pa-10-15">
