...
<head>
<!-- Title -->
<title>File Details - Owner | xACS</title>
...
<body>
		...
		<div
			...
			<div class="g-pa-20">
				...
				<div class="alert alert-success alert-dismissible fade show"
					...
					<h4 class="h5">
						<i class="fa fa-check-circle-o"></i> File Deleted!
					</h4>
					File successfully deleted from Database.
				</div>

				<div class="alert alert-danger alert-dismissible fade show"
					role="alert" id="delFailAlert"
					style="visibility: hidden; display: none;">
					<button type="button" class="close" data-dismiss="alert"
						aria-label="Close">
						<span aria-hidden="true">×</span>
					...
					<h4 class="h5">
						<i class="fa fa-minus-circle"></i> Delete Failed!
					</h4>
				...
				<div class="row">
					<div class="col-auto g-width-280">
						<h1 class="g-font-weight-500 g-font-size-28 g-color-black g-mb-20">File
							Details</h1>
					</div>
					...
					<div class="col">
						<div class="media g-py-3">
							<div class="d-flex align-self-center align-items-center">
								<span
									class="g-hidden-sm-down g-color-gray-dark-v6 g-mr-12 g-pt-10"
									id="showing">Showing # files</span>
							...
							<div class="d-flex align-self-center align-items-center ml-auto">
								<ul class="list-inline mb-0">
									<li class="list-inline-item g-valign-middle"><a
										class="d-flex align-items-center u-link-v5 g-font-size-18 g-color-gray-light-v6 g-color-lightblue-v3--active active"
										href="#!"> <i class="hs-admin-layout-grid-3 g-mr-10"></i>
											<span
											class="g-hidden-sm-down g-font-size-default g-color-gray-dark-v6 g-color-black--active active">Grid
												View</span>
									</a></li>
								</ul>
							</div>
				...
				<div class="row">
					<div class="col-md-auto g-width-280--md">
						<ul class="list-unstyled mb-0">
							<li class="g-mb-10"><a
								class="media u-link-v5 g-bg-gray-light-v8--active g-bg-gray-light-v8--hover g-font-size-16 g-color-gray-dark-v6 g-rounded-2 g-px-20 g-py-12 active"
								href="#!"> <span
									class="d-flex align-self-center g-font-size-18 g-color-gray-light-v6 g-mr-20">
										<i class="hs-admin-folder"></i>
								</span> <span class="media-body align-self-center">All Files</span>
							</a></li>
							<li class="g-mb-10"><a
								class="media u-link-v5 g-bg-gray-light-v8--active g-bg-gray-light-v8--hover g-font-size-16 g-color-gray-dark-v6 g-rounded-2 g-px-20 g-py-12"
								href="#!"> <span
									class="d-flex align-self-center g-font-size-18 g-color-gray-light-v6 g-mr-20">
										<i class="hs-admin-files"></i>
								</span> <span class="media-body align-self-center">Recent</span>
							</a></li>
							<li class="g-mb-10"><a
								class="media u-link-v5 g-bg-gray-light-v8--active g-bg-gray-light-v8--hover g-font-size-16 g-color-gray-dark-v6 g-rounded-2 g-px-20 g-py-12"
								href="#!"> <span
								...
								</span> <span class="media-body align-self-center">Favourites</span>
							</a></li>
							<li class="g-mb-10"><a
								class="media u-link-v5 g-bg-gray-light-v8--active g-bg-gray-light-v8--hover g-font-size-16 g-color-gray-dark-v6 g-rounded-2 g-px-20 g-py-12"
								href="#!"> <span
								...
								</span> <span class="media-body align-self-center">Trash</span>
							</a></li>
						</ul>
					...
					<div class="col-md">
						<div class="row">
							...
							<%
								...
								Statement st = null;
								ResultSet rs = null;
								String owner = (String) session.getAttribute("usr_name");
								int rsCount = 0;
								try {
									con = DbConnection.getConnection();
									st = con.createStatement();
									rs = st.executeQuery(
											"select *, OCTET_LENGTH(encFile) as size from file_upload where owner='" + owner + "'");
									while (rs.next()) {
										...
										size_stirng = new DecimalFormat("#,##0.#").format(size / Math.pow(1024, digitGroups)) + " "
												+ units[digitGroups];
										rsCount++;
							%>
							...
							<div class="col-md-3 g-mb-30">
								<div
									class="d-flex flex-wrap h-100 g-brd-around g-brd-gray-light-v7 g-rounded-2 u-card-v1 g-pa-25">
									<header
										class="w-100 align-self-start text-right justify-content-end g-pos-rel g-mb-10">
										<span
											class="pull-left g-font-size-20 align-self-end g-line-height-1 g-font-weight-400 g-color-primary g-pt-10">#</span>
										<span
											class="pull-left g-font-size-32 g-line-height-1 g-font-weight-500 g-color-primary g-mb-10"><%=rs.getString("id")%></span>
										...
										<a id="dropDown<%=rsCount%>Invoker"
											class="u-link-v5 g-line-height-0 g-font-size-24 g-color-gray-light-v6 g-color-lightblue-v3--hover g-pr-10"
											href="#!" aria-controls="dropDown<%=rsCount%>"
											aria-haspopup="true" aria-expanded="false"
											data-dropdown-event="click"
											data-dropdown-target="#dropDown<%=rsCount%>"
											data-dropdown-type="jquery-slide"> <i
											class="hs-admin-more-alt"></i>
										</a>

										<div id="dropDown<%=rsCount%>"
											class="u-shadow-v31 g-pos-abs g-right-0 g-bg-white u-dropdown--jquery-slide u-dropdown--hidden"
											aria-labelledby="dropDown<%=rsCount%>Invoker"
											...
											<ul class="list-unstyled g-nowrap mb-0">
												<li><a
													...
													href="../owner_fileDelete?<%=rs.getString("id")%>"> <i
										...
										<!--<span class="pull-right u-tags-v1 text-center g-bg-white g-color-primary g-brd-around g-brd-primary g-rounded-50 g-py-2 g-px-10">OWNER JAVA</span>-->


									</header>

									<section
										class="w-100 align-self-center text-center g-color-darkblue-v2 g-mb-30">
										<svg width="50px" height="64px" viewBox="0 0 58 74"
											version="1.1" xmlns="http://www.w3.org/2000/svg"
											xmlns:xlink="http://www.w3.org/1999/xlink">
                                                <g stroke="none"
												stroke-width="1" fill="none" fill-rule="evenodd">
                                                <g
												transform="translate(-359.000000, -868.000000)"
												fill="<%=hexColor%>">
                                                <g
												transform="translate(284.000000, 730.000000)">
                                                <g
												transform="translate(0.000000, 76.000000)">
                                                <g
												transform="translate(75.000000, 62.000000)">
                                                <rect opacity="0.15"
												x="0" y="36" width="58" height="27"></rect>
                                                <path
												d="M40.0002553,0 L0,0 L0,74 L58,74 L58,17.9894 L40.0002553,0 Z M40.7234043,4.2106 L53.7869787,17.2666667 L40.7234043,17.2666667 L40.7234043,4.2106 Z M2.46808511,71.5333333 L2.46808511,2.46666667 L38.2553191,2.46666667 L38.2553191,19.7333333 L55.5319149,19.7333333 L55.5319149,71.5333333 L2.46808511,71.5333333 Z"
												fill-rule="nonzero"></path>
                                                <text font-size="14"
												font-weight="normal" letter-spacing="0.209999993">
                                                <tspan x="15.7045117"
												y="52">.<%=extension%></tspan>
                                                </text>
                                                </g>
                                                </g>
                                                </g>
									...
									<footer class="w-100 align-self-end text-center">
										<div
											class="d-flex align-items-center justify-content-center g-mb-10">
											<span
												class="g-line-height-1_2 g-font-size-default g-font-weight-600 g-color-black"><%=basename%></span>
										</div>
										...
										<div
											...
											<div class="media-body text-center">
												<span
													class="g-hidden-sm-down g-font-weight-300 g-color-gray-dark-v6 ink">
	...
	<script>
            $(document).ready(function () {
                ...
                if (window.location.href.indexOf('#delSucc') !== -1) {
                    $('#delSuccAlert').css({
                        'visibility': 'visible',
                        'display': 'block'
                    });
                ...
                if (window.location.href.indexOf('#delFail') !== -1) {
                    $('#delFailAlert').css({
                        'visibility': 'visible',
                        'display': 'block'
                    });
                ...
                document.getElementById('showing').innerHTML = "Showing <%=rsCount%>
		files";
