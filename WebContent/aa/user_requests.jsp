            ...
            <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
                ...
                <div class="col g-bg-lightblue-v10-opacity-0_5 g-ml-45 g-ml-0--lg g-pb-65--md">
                    ...
                    <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
                        <ul class="u-list-inline g-color-gray-dark-v6">
                            ...
                            <li class="list-inline-item">
                                <span class="g-valign-middle">User Requests</span>
                            </li>
                        </ul>
                    </div>
                    <!-- End Breadcrumb-v1 -->
                    ...
                    <div class="g-pa-20">
                        ...
                        <div class="alert alert-success alert-dismissible fade show" role="alert" id="sendSuccAlert" style="visibility: hidden; display: none;">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" role="alert" id="sendFailAlert" style="visibility: hidden; display: none;">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                            <h4 class="h5">
                                <i class="fa fa-minus-circle"></i>
                                Unable to send SK! Please try again later.
                            </h4>
                        ...
                        <div class="media-md align-items-center g-mb-30">
                            <div class="d-flex g-mb-15 g-mb-0--md">
                                <h1 class="g-font-weight-500 g-font-size-28 g-color-black">Download Requests</h1>
                            </div>
                                ...
                                <table class="js-datatable table table-striped u-table--v3 u-editable-table--v1 g-color-black u-card-v1 dataTable no-footer" data-dt-search="#datatableSearch1" data-dt-pagination="datatablePagination1" data-dt-page-length="500" data-dt-is-responsive="false">                                   
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <div class="media">
                                                    <div class="d-flex align-self-center g-nowrap">File Name</div>
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            try {
                                                ...
                                                rs = st.executeQuery("select * from request where (aa1 not like '"+user_id+"' or aa1 is null) and (aa2 not like '"+user_id+"' or aa2 is null) and (aa3 not like '"+user_id+"' or aa3 is null) and (aa4 not like '"+user_id+"' or aa4 is null) and (aa5 not like '"+user_id+"' or aa5 is null) and (aa6 not like '"+user_id+"' or aa6 is null) and (aa7 not like '"+user_id+"' or aa7 is null) and (aa8 not like '"+user_id+"' or aa8 is null) and (aa9 not like '"+user_id+"' or aa9 is null) and (aa10 not like '"+user_id+"' or aa10 is null) and status = 'No';");
                                                while (rs.next()) {
                                                    count++;
                                        %>
                                        <tr>
                                            ...
                                            <td style=" width:0.1%; white-space: nowrap;">
                                                <div class="media">
                                                    <div class="media-body align-self-center" href="#!">
                                                        <a class="u-tags-v1 text-center g-bg-lightblue-v3 g-brd-lightblue-v3 g-width-140 g-color-white g-brd-around g-rounded-50 g-py-4 g-px-15" href="../aa_send?id=<%=rs.getString("id")%>" style="font-weight: bolder;">Send</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
