		...
		<div id="sideNav"
			...
			<ul id="sideNavMenu"
				...
				<li
					...
					<a
					class="media u-side-nav--top-level-menu-link u-side-nav--hide-on-hidden g-px-15 g-py-12"
					href="dl_details.jsp"> <span
						class="d-flex align-self-center g-pos-rel g-font-size-18 g-mr-18">
							<i class="hs-admin-download "></i>
					</span> <span class="media-body align-self-center">Download Details</span>
				</a>
				</li>
			</ul>
		</div>
					...
					<div class="col-xl-9">
						...
						<div
							...
							<header class="media g-mb-30">
								<h3
									class="d-flex align-self-center text-uppercase g-font-size-12 g-font-size-default--md g-color-black mb-0">Statistics</h3>
								...
								<ul class="list-unstyled d-flex align-self-center pull-right"
									...
									<li class="media">
										...
										<div
											class="media-body align-self-center g-font-size-12 g-font-size-default--md">DATA1</div>
									</li>
									<li class="media g-ml-5 g-ml-35--md">
										...
										<div
											class="media-body align-self-center g-font-size-12 g-font-size-default--md">DATA2</div>
									</li>
								</ul>
							</header>
