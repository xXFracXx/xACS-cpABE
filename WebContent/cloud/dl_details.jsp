...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>Download Details - Cloud | xACS </title>
                    ...
                    <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
                        <ul class="u-list-inline g-color-gray-dark-v6">
                            ...
                            <li class="list-inline-item">
                                <span class="g-valign-middle">Download Details</span>
                            </li>
                        </ul>
                    </div>
                    <!-- End Breadcrumb-v1 -->
                    <div class="g-pa-20">
                        ...
                        <div class="media-md align-items-center g-mb-30">
                            <div class="d-flex g-mb-15 g-mb-0--md">
                                <h1 class="g-font-weight-500 g-font-size-28 g-color-black">File Download Details</h1>
                            </div>
                                ...
                                <table class="js-datatable table table-striped u-table--v3 u-editable-table--v1 g-color-black u-card-v1 dataTable no-footer" data-dt-search="#datatableSearch1" data-dt-pagination="datatablePagination1" data-dt-page-length="500" data-dt-is-responsive="false">                                   
                                    <thead>
                                        <tr>
                                            <th>
                                                <div class="media">
                                                    <div class="d-flex align-self-center">S ID</div>
                                            ...
                                            <th>
                                                <div class="media">
                                                    <div class="d-flex align-self-center">User Name</div>
                                            ...
                                            <th>
                                                <div class="media">
                                                    <div class="d-flex align-self-center">Time</div>
